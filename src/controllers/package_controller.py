...
def process_file(report_service: ReportService = Depends(get_report_service), service: PackageSorterService = Depends(get_package_sorter_service)):
    report_service.process_report(service, csv_file_name)
